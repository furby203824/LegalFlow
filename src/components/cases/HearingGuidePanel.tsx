                ...
                {p.fieldType === "currency" && (
                  <div className="flex items-center gap-2">
                    ...
                    <input
                      ...
                      max={p.max}
                      step="1"
                      className="input-flat text-xs w-28"
                    ...
                    {isField && (
                      <>
                        ...
                        <select
                          className="input-flat text-xs w-20"
      ...
      {punishments.some((p) => responses[`${p.key}_susp`] === "yes") && (
        <div className="rounded-md border border-amber-300 bg-amber-50 p-3">
          <div className="flex items-center gap-2 text-sm">
            ...
            <select
              className="input-flat text-sm w-24 text-center"
    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 p-3 bg-surface rounded-lg border border-border">
        <div>
          ...
          <input className="input-flat text-sm" value={appealAuthority} onChange={(e) => setAppealAuthority(e.target.value)} placeholder="e.g., Commanding General, 1st MARDIV" />
        </div>
        <div>
          <label className="block text-xs font-medium text-neutral-mid mb-1">Who Reads Appellate Rights</label>
          <input className="input-flat text-sm" value={appellateRightsReader} onChange={(e) => setAppellateRightsReader(e.target.value)} placeholder="e.g., Capt Smith, Legal" />
        </div>
      </div>
        ...
        <div className="border border-border rounded-lg overflow-hidden">
          ...
          <div className="p-5">
            ...
            {step.responseType === "freetext" && step.responseKey && (
              <div className="mt-4">
                <textarea
                  className="input-flat min-h-[80px] text-sm"
