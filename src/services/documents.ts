...
export async function generateDocumentContent(
  ...
  const caseData: CaseData = {
    ...
    item2ElectionAccepted: sig2 ? !sig2.demandedTrial : undefined,
    ...
    appealAuthorityName: appeal?.appealAuthorityName || njpCase.hearingRecord?.appealAuthority || undefined,
    appealAuthorityRank: appeal?.appealAuthorityRank,
