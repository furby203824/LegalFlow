...
// Hierarchy: Company → Battalion → Regiment
const DEMO_USERS = [
  // --- System Admin ---
  {
    username: "admin",
  ...
  // --- Company Level (Alpha Co, 1st Bn, 5th Marines) ---
  {
    username: "co-preparer",
    passwordHash: "co-preparer",
    firstName: "James",
    lastName: "Rodriguez",
    email: "james.rodriguez@usmc.mil",
    role: "NJP_PREPARER",
    unitId: "unit-aco1bn5mar",
    unitName: "Alpha Co, 1st Bn, 5th Marines",
    rank: "Sgt",
    grade: "E5",
    edipi: "1234567890",
  },
  ...
  },
  {
    ...
    passwordHash: "co-certifier",
    firstName: "David",
    lastName: "Park",
    email: "david.park@usmc.mil",
    role: "CERTIFIER",
    unitId: "unit-aco1bn5mar",
    unitName: "Alpha Co, 1st Bn, 5th Marines",
    rank: "Capt",
  ...
  // --- Battalion Level (1st Bn, 5th Marines) ---
  {
    username: "bn-preparer",
    passwordHash: "bn-preparer",
    firstName: "Kevin",
    lastName: "Torres",
    email: "kevin.torres@usmc.mil",
    role: "NJP_PREPARER",
    unitId: "unit-1bn5mar",
    unitName: "1st Bn, 5th Marines",
    rank: "Sgt",
  ...
  },
  {
    ...
    passwordHash: "bn-reviewer",
    firstName: "Lisa",
    lastName: "Nguyen",
    email: "lisa.nguyen@usmc.mil",
    role: "CERTIFIER_REVIEWER",
    unitId: "unit-1bn5mar",
    unitName: "1st Bn, 5th Marines",
    rank: "MSgt",
  ...
  // --- Regiment Level (5th Marine Regiment) ---
  {
    username: "regt-certifier",
    passwordHash: "regt-certifier",
    firstName: "Robert",
    lastName: "Hayes",
